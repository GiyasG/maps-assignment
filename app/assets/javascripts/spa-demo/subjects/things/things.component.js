(function() {
  ...
  function ThingEditorController($scope, $q, $state, $stateParams,
    ...
    function reload(thingId) {
      ...
      vm.thingtags = ThingTag.query({id:itemId});
      // console.log("query:", vm.thingtags);

      vm.thingtags.$promise.then(
        function() {
          angular.forEach(vm.thingtags, function(tt){
              if (angular.isArray(tt)) {
                vm.tagforthing.push(tt);
      ...
      // console.log("item promise", vm.item.$promise);
    }
